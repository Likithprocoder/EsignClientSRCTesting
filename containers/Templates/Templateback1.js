...
function NewTemplate(props) {
                                                                ...
                                                                {cameraIsOpen && !captureData && (
                                                                    <div>
                                                                        ...
                                                                        <Webcam videoConstraints={{
                                                                            ...
                                                                            screenshotFormat="image/png" screenshotQuality={1} ref={webcamRef} className="Webcam" >
                                                                            {({ getScreenshot }) => (
    ...
    const proceedingWithImg = async (base64imgData) => {
        ...
        if (fileSizeInmb > 2) {
            ...
            document.getElementById(iterationId.split(",")[0] + "1").style.backgroundColor = "#ffc107db";
